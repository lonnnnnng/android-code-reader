...
- 设置页“关于与更新 / 应用更新”显示当前版本 `v0.1.4`。
- 点击“检查更新”后真实请求 `lonnnnnng/android-code-reader` 的公开 GitHub Latest Release；发布后复核返回“当前已是最新版本 v0.1.4”。
...
```text
文件：AndroidCodeReader-v0.1.4.apk
大小：11,070,831 bytes（约 10.6 MiB）
SHA-256：e0c891fb1e6ad125cd3a91999415e657459c8f2b7a88d554681069a14f01f60b
```
