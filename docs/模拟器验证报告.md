...
`v0.1.7 (8)` 完成中文品牌更名：系统应用标签、首页标题、退出确认、更新授权提示、README 和内置 Markdown 示例统一使用“灵阅”；应用 ID、GitHub 仓库和 APK 命名协议保持不变，继续兼容既有安装与在线更新。本轮重新完成构建、正式签名、`v0.1.6 -> v0.1.7` 原地安装、完整 instrumentation 和启动检查。
...
- 设置页“关于与更新 / 应用更新”显示当前版本 `v0.1.7`。
- 本轮发布前真实请求 `lonnnnnng/android-code-reader` 的公开 GitHub Latest Release；当远端仍为 `v0.1.6` 时，当前 `v0.1.7` 正确返回已是最新版本。发布后将再次复核远端 Latest Release。
...
```text
文件：AndroidCodeReader-v0.1.7.apk
大小：11,070,831 bytes（约 10.6 MiB）
SHA-256：fbfeb757c57c706475d19b89e67617488ca7a89935938318db08205b0449dabb
```
