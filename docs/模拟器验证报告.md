...
`v0.1.6 (7)` 是维护版本：相对 `v0.1.5 (6)` 没有新增应用功能代码，主要递增正式版本并纳入上一版在线升级的完整验证记录。本轮仍重新完成构建、正式签名、`v0.1.5 -> v0.1.6` 原地安装、完整 instrumentation 和启动检查。
...
- 设置页“关于与更新 / 应用更新”显示当前版本 `v0.1.6`。
- 本轮发布前点击“检查更新”后真实请求 `lonnnnnng/android-code-reader` 的公开 GitHub Latest Release；当远端仍为 `v0.1.5` 时，当前 `v0.1.6` 正确返回已是最新版本。发布后将再次复核远端 Latest Release。
...
```text
文件：AndroidCodeReader-v0.1.6.apk
大小：11,070,831 bytes（约 10.6 MiB）
SHA-256：582d4add04eb34fcb34f924a831afefdae6139acaf5ab3ec9d75a4a4ebc4e2e6
```
