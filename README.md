...
| Markdown | 源码/预览、语义块位置同步、Front Matter 折叠、代码高亮、KaTeX、Mermaid、本地图片与附件、图片放大、表格、任务列表、脚注、目录、代码复制 |
...
- `Pixel_9` Android 模拟器全量 instrumentation：`50/50` 通过。
- 语法覆盖：`78/78` 通过。
...
| M2 | Front Matter、本地资源、失败回退、预览缓存、源码/预览同步已完成；继续目录交互、导出 | 🚧 推进中 |
