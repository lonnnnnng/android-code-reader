...
| 常用语法 | 高级内容 | 阅读辅助 |
| --- | --- | --- |
| 标题、引用、列表、表格、任务列表、脚注 | YAML Front Matter、代码块高亮、KaTeX 数学公式、Mermaid 流程图 | 目录跳转、代码块复制、明暗主题、离线渲染 |
...
| Markdown | 源码/预览、Front Matter 折叠、代码高亮、KaTeX、Mermaid、表格、任务列表、脚注、目录、代码复制 |
...
- `Pixel_9` Android 模拟器全量 instrumentation：`47/47` 通过。
- 语法覆盖：`78/78` 通过。
...
| M2 | Front Matter 已完成；本地图片/附件、预览缓存、源码/预览同步、导出 | 🚧 推进中 |
