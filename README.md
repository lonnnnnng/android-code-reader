...
| 常用语法 | 高级内容 | 阅读辅助 |
| --- | --- | --- |
| 标题、引用、列表、表格、任务列表、脚注 | YAML Front Matter、代码块高亮、KaTeX 数学公式、Mermaid 流程图、本地图片 | 目录跳转、代码块复制、图片放大、相对附件、明暗主题、离线渲染 |
...
| M2 | Front Matter、本地图片/附件、失败回退已完成；继续预览缓存、源码/预览同步、导出 | 🚧 推进中 |
