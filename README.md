...
- ZIP 安全解压和项目浏览。
- 公共 HTTPS Git 仓库浅克隆。
- 最多 5000 条目的可折叠项目树，目录、ZIP、Git 和内置样例使用同一套项目索引。
...
- 内置 78 个覆盖测试文件，74 个文件类型分类和 72 套 TextMate grammar。
...
```bash
./gradlew testDebugUnitTest lintDebug assembleDebug assembleDebugAndroidTest --console=plain
```
