...
- 首页提供两级设置页；一级按“阅读与显示 / 应用外观 / 关于与更新”分类，二级集中配置具体选项。11-24 sp 字号、阅读背景、整体强调色和明暗模式均可实时预览并持久化。
- 设置页支持从 GitHub Releases 在线检查更新，展示版本说明和下载进度，并在完成 SHA-256、文件大小、应用 ID、版本号和签名证书校验后交给系统安装器。
...
- Pixel_9 模拟器已通过 15 项 instrumentation 和 78/78 语法 token 验证；当前项目禁止使用 Redmi 真机做验证。
